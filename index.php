...
$app->get("/", function() use($app, $db){
	echo "Hola mundo desde api rest";
});
...
$app->get('/empleado', function() use($db, $app){
...
$app->get('/empleado/:id', function($id) use($db, $app){
...
$app->post('/productos', function() use($app, $db){
	...
	if(!isset($data['nombre_vendedor'])){
		$data['nombre_vendedor']=null;
	}
	if(!isset($data['estado_vendedor'])){
		$data['estado_vendedor']=null;
	}
	if(!isset($data['numero_telf'])){
		$data['numero_telf']=null;
	}
